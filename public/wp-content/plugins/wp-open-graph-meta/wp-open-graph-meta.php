...
class de_omaxis_wp_open_graph_meta
{
    ...
    protected function _add_image()
    {
	    ...
	    //$temp = wp_get_attachment_url(get_post_thumbnail_id());
	    //$temp_a = substr($temp,0,strlen($temp)-4);
	    //$temp_b = substr($temp,strlen($temp)-4);
            //$this->_metas['og:image'] = $temp_a.'-150x150'.$temp_b;
