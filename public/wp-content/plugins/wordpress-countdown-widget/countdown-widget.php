...
//-->
		...
		<p><label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Widget Title:', 'countdown-widget'); ?> <small><a href="http://metinsaylan.com/docs/countdown-widget-help/#title" target="_blank" rel="external">(?)</a></small> <input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo $title; ?>" /></label></p>

		<p><label for="<?php echo $this->get_field_id('event'); ?>"><?php _e('Event Title:', 'countdown-widget'); ?> <small><a href="http://metinsaylan.com/docs/countdown-widget-help/#event-title" target="_blank" rel="external">(?)</a></small> <input class="widefat" id="<?php echo $this->get_field_id('event'); ?>" name="<?php echo $this->get_field_name('event'); ?>" type="text" value="<?php echo $event; ?>" /></label></p>
		...
		<p><label for="<?php echo $this->get_field_id('direction'); ?>"> <?php _e('Count Down/Up :', 'countdown-widget'); ?></label>
			...
			</select> <a href="http://metinsaylan.com/docs/countdown-widget-help/#direction" target="_blank">(?)</a>
		</p>

		<p><label for="<?php echo $this->get_field_id('date'); ?>"><?php _e('Date :', 'countdown-widget'); ?></label> <small><a href="http://metinsaylan.com/docs/countdown-widget-help/#date" target="_blank" rel="external">(?)</a></small> <input type="text" class="widefat datepicker" name="<?php echo $this->get_field_name('date'); ?>" id="<?php echo $this->get_field_id('date'); ?>" value="<?php echo $date; ?>"/><br />
		...
		<small>HH:MM:SS</small> <small><a href="http://metinsaylan.com/docs/countdown-widget-help/#time" target="_blank" rel="external">(?)</a></small></p>

		<p><label for="<?php echo $this->get_field_id('format'); ?>"><?php _e('Format :', 'countdown-widget'); ?></label> <small><a href="http://metinsaylan.com/docs/countdown-widget-help/#format" target="_blank" rel="external">(?)</a></small> <input id="<?php echo $this->get_field_id('format'); ?>" name="<?php echo $this->get_field_name('format'); ?>" class="widefat" type="text" value="<?php echo $format; ?>" size="10" maxlength="8" placeholder="yowdHMS" /><br />  </p>
		...
		<label for="<?php echo $this->get_field_id('link'); ?>"><?php _e( 'Remove link' , 'countdown-widget'); ?></label> <small><a href="http://metinsaylan.com/docs/countdown-widget-help/#remove-link" target="_blank" rel="external">(?)</a></small></p>
