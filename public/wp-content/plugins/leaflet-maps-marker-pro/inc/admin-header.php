...
if ( ($action == 'add') || ($action == 'edit') || ($action == 'duplicate') ) {
	...
	<table cellpadding="5" cellspacing="0" class="widefat fixed">
	  <tr>
		<td><div class="logo-rtl" style="<?php echo $css_whitelabel = ($lmm_options['misc_whitelabel_backend'] == 'enabled') ? 'display:none' : '' ?>"><a href="https://www.mapsmarker.com/go" target="_blank" title="www.mapsmarker.com"><img src="<?php echo LEAFLET_PLUGIN_URL ?>inc/img/logo-mapsmarker-pro.png" width="65" height="65" alt="Maps Marker Pro Plugin Logo by Julia Loew, www.weiderand.net" /></a></div>
	<?php
