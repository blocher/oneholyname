...
== Upgrade Notice ==
= v1.9.1 =
bugfix and compatibility release (MapsMarker API, bing localization...) - see https://www.mapsmarker.com/v1.9.1p for more details

== Changelog ==
[blog post with details about v1.9.1](https://www.mapsmarker.com/v1.9.1p)
